...
import com.ai.exception.InvalidAnswerException;
...
public class SelfEvaluatingChatController {
    ...
    public SelfEvaluatingChatController(@Qualifier("gemmaChatClient") ChatClient chatClient, @Qualifier("gemmaModel") ChatModel chatModel,
                                        @Value("classpath:/promptTemplates/factcheck.st") Resource factCheckTemplate) throws IOException {
        this.chatClient = chatClient;
        this.factCheckingEvaluator = FactCheckingEvaluator.builder(ChatClient.builder(chatModel))
    ...
    public String chat(@RequestParam("message") String message) {
        ...
        validateAnswer(message, "The capital of India is London");
        return aiResponse;
    }
